        ...
        <div className="flex container mx-auto justify-between items-center">
          ...
          {user ? (
            <div className="flex gap-2">
              ...
              <button
                onClick={logoutUser}
                className=" px-6 py-2 rounded-full text-white bg-orange-500 cursor-pointer hover:bg-orange-600 duration-300"
              >
                Logout
              </button>
            </div>
            ...
            <Link
              to={"/login"}
              className="bg-orange-500 text-white py-2 rounded-full px-8 cursor-pointer hover:bg-orange-600 duration-300"
            >
              Singin
            </Link>
          )}
